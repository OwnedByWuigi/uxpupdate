Write-Output "Creating scheduled task for uxpupdate..."
$Title = "uxpupdate"
...
$Action   = New-ScheduledTaskAction -Execute "uxpupdate.exe" -Argument "/Scheduled" -WorkingDirectory "$PSScriptRoot"
